                ...
                <div className="grid grid-cols-3 items-start mb-20 gap-16">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mb-5 items-start">
                            <img src="/assets/content-img/recent_post1.jpg" className="h-full w-auto" />
                            <div>
                        ...
                        <div className="flex gap-4 items-start">
                            <img src="/assets/content-img/recent_post2.jpg" className="h-full w-auto" />
                            <div>
                                <p className="w-60 leading-8 tracking-[0.02em]">
                                    Lorem Ipsum is simply dummy text of the printing and typesetting.
                                </p>
                    ...
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="flex gap-5 justify-center">
                            ...
                            <div className="h-8 w-8 border border-white flex items-center justify-center cursor-pointer">
                                <img src="/assets/icon/facebook.png" className="h-4 w-4 object-contain" />
                            </div>

                            <div className="h-8 w-8 border border-white flex items-center justify-center cursor-pointer">
                                <img src="/assets/icon/snap.png" className="h-4 w-4 object-contain" />
                            </div>

                            <div className="h-8 w-8 border border-white flex items-center justify-center cursor-pointer">
                                <img src="/assets/icon/insta.png" className="h-4 w-4 object-contain" />
                            </div>
