  ...
  return (
    <div className="max-w-300 mx-auto">
      <div className="grid">
        ...
        {state?.error && (
          <p className="text-red-500 text-center text-sm sm:text-base px-4 max-w-md mx-auto leading-relaxed wrap-break-word">
            {state.error}
          </p>
        )}

        {state?.success && (
          <p className="text-green-500 text-center text-sm sm:text-base px-4 max-w-md mx-auto leading-relaxed wrap-break-word -mt-10 mb-10">
            {state.success}
          </p>
        )}
      </div>
