...
export default function Comments({ comments, eventId }) {
  ...
  return (
    <div className="max-w-300 mx-auto px-4 sm:px-6 md:px-8 mt-20 md:mt-45">
      <div>
        <h2 className="font-bold text-2xl tracking-[0.02em] mb-10 uppercase text-left">
          {comments.length} Comments
        </h2>

        {comments.map((comment) => (
          <div key={comment.id} className="mb-8 text-left">
            <h3 className="mb-4">
      ...
      <div className="flex flex-col items-center mt-12 md:mt-20 mb-10">
        ...
        >
          ...
          <textarea
            ...
            name="comment"
            className="border p-4 w-full sm:col-span-2 min-h-40 bg-transparent text-white"
            required
          />
          ...
          <div className="sm:col-span-2 flex justify-end mt-3 mb-20">
            <button
              type="submit"
              disabled={isPending}
